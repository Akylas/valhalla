...
valhalla::odin::locales_singleton_t load_narrative_locals(valhalla::odin::json_locales_map_t custom_locales) {
...
const locales_singleton_t& get_locales(valhalla::odin::json_locales_map_t custom_locales) {
